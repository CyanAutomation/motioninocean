...
export async function copyDiagnosticReport(actions) {
    ...
    try {
        await globalThis.navigator.clipboard.writeText(actions.buildDiagnosticTextReport(diagnosticResult));
...
export function bindDashboardControls({ elements, actions }) {
    ...
    bindOptionalButton(elements.copyDiagnosticReportBtn, "click", () => copyDiagnosticReport(actions));
}
/**
